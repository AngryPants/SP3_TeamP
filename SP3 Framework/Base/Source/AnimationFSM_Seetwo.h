#ifndef ANIMATION_FSM_Seetwo_H
#define ANIMATION_FSM_Seetwo_H

#include "AnimationFSM.h"
#include "MeshBuilder.h"
#include "TextureManager.h"

class AnimationFSM_Seetwo {
...
private:
	...
	void InitAnimation() {
		texture.textureArray[0] = TextureManager::GetInstance().AddTexture("Seetwo", "Image//Cyborg_Shooter//Characters//Heroes//Hero_Seetwo.tga");
		mesh = MeshBuilder::GetInstance().GenerateSpriteAnimation("Seetwo", 6, 10);
		...
		animation[JUMPING_SHOOTING].Set(40, 49, true, 1.0, true);
		animation[DEAD].Set(50, 59, false, 1.0, true);
	}
