...
enum TILE_INDEX {
	...
	TILE_CHECKPOINT_SET = 0x60, //96
	TILE_DOOR_OPEN = 0x70, // 112
	TILE_DOOR_CLOSE = 0x80, // 128
	TILE_BOOSTPAD_LEFT = 0x90, // 144
	TILE_BOOSTPAD_RIGHT = 0xA0, // 160
	TILE_BOOSTPAD_DOWN = 0xB0, // 176
	TILE_BOOSTPAD_UP = 0xC0, // 192
	TILE_HEALTH = 0xD0, // 208
	...
	// Sawblade Index
	TILE_SAWBLADE_INDEX_1 = 0x100000, // 1048576
	TILE_SAWBLADE_INDEX_2 = 0x200000,

	// Sawblade Node
	TILE_SAWBLADE_NODE_1 = 0x1000000, // 16777216
	TILE_SAWBLADE_NODE_2 = 0x2000000,
